...
parcela_inicial <- read_delim("numero_recibo.txt",
                            col_names = TRUE,
...
if(parcela_inicial$ano != format(Sys.Date(),"%Y")){
  ...
  write_delim(parcela_inicial,"/numero_recibo.txt")
  
  df_controle <- read_delim("/controle_recibo_consultor_mes.txt",
                          col_names = TRUE,
                          show_col_types = FALSE)
  ...
  write_delim(df_controle, "/controle_recibo_consultor_mes.txt", append = FALSE)
  ...
  write_delim(df_final,"/controle_recibo_consultor_mes.txt", append = FALSE)
